...
class Inventario:
    ...
    def agregar_producto(self, producto):
        ...
        print(f"Producto '{producto.nombre}' agregado exitosamente al archivo de inventario.")
    ...
    def actualizar_producto(self, codigo, cantidad=None, precio=None):
        if codigo in self.productos:
            ...
            self.guardar_en_archivo()
            print(f"Producto '{self.productos[codigo].nombre}' actualizado correctamente en el archivo de inventario.")
        else:
            print("Error: Producto no encontrado en el archivo de inventario.")

    def eliminar_producto(self, codigo):
        if codigo in self.productos:
            del self.productos[codigo]
            self.guardar_en_archivo()
            print("Producto eliminado exitosamente del archivo de inventario.")
        else:
            print("Error: Producto no encontrado en el archivo de inventario.")
    ...
    def cargar_desde_archivo(self):
        ...
        try:
            ...
            print("Error al leer el archivo. Puede estar corrupto. Se inicializará un inventario vacío.")
        except Exception as e:
